...
const slice = createSlice({
  ...
  reducers: {
    ...
    getGroupsRequestAction(state: Draft<typeof initialState>) {
      state['inProcess'] = true;
    },
    getGroupsRequestFailAction(state: Draft<typeof initialState>) {
      state['inProcess'] = false;
    },
    getGroupsRequestSuccessAction(state: Draft<typeof initialState>, { payload }: PayloadAction<any>) {
